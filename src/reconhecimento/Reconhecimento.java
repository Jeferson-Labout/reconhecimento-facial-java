...
public class Reconhecimento {
    public static void main(String args[]) throws FrameGrabber.Exception {
        ...
        String[] pessoas = {"", "Jeferson", "Igor","Jhonatan","Keyze","Giullanna","Guilherme","Glaubiano"};
        camera.start();
        ...
        while ((frameCapturado = camera.grab()) != null) {
            ...
            for (int i = 0; i < facesDetectadas.size(); i++) {
                ...
                putText(imagemColorida, nome, new Point(x, y), FONT_HERSHEY_PLAIN, 2.4, new Scalar(0,255,0,0));
            }
            if (cFrame.isVisible()) {
